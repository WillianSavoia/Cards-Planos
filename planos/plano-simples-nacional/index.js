...
const Plano_Pro = [
   ' Informação Jurídica',
    ...
    'Procuração 3 / ano',
    'Notificação Extra Judicial 3 / anos',
    'Emissão de Certidões',
    'NDA',
    'Sem cobrança de 13ª parcela',
];
...
const Prices = [{
    ...
    economic_price1: 'R$199,00',
    economic_price2: 'R$255,00',
 
 
    basic_price1:  'R$357,00',
    basic_price2: 'R$417,00',
 
 
    premium_price1: 'R$497,00',
    premium_price2: 'R$577,00',
